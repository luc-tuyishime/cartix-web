...
function leafletCartix() {
    ...
    $("#map-cartix").html('<div id="map"> <div class="container-fluid headerOnMap"> <div class="row"> <div class="col-md-2"><img alt="" src="assets/img/afr-logo.png" class="afr-logo"> </div><div class="col-md-10 selectBox"> <div class="select-box"> <select class="multiselect" ng-model="national" data-placeholder="National" id="national_map" multiple="multiple"> <option value="provinces">Provinces</option> <option value="districts">Districts</option> <option value="sectors">Sectors</option> </select> </div><div class="select-box "> <select data-placeholder="Provinces" ng-model="province_map" ng-options="province for province in provinces" id="province_map" multiple="multiple"> </select> </div><div class="select-box "> <select data-placeholder="District" id="district_map" ng-model="district_map" ng-options="district for district in districts" multiple="multiple"> </select> </div><div class="select-box "> <select data-placeholder="Saving Groups" id="saving_group_map" ng-model="ngo_list" ng-options="ngo for ngo in ngos" multiple="multiple"> </select> </div><div class="select-box "> <select data-placeholder="Year" id="year" ng-model="year" ng-options="year for year in years" multiple="multiple"> </select> </div></div></div><div class="row"> <div class="btn-cartix-bottom"> <button type="button" class="btn btn-default btn-cartix" onclick="openNav()">Data</button> </div></div></div></div>');
